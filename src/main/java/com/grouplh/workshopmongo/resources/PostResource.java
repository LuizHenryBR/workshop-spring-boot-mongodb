...
import com.grouplh.workshopmongo.resources.util.URL;
...
public class PostResource {
	...
	public ResponseEntity<List<Post>> fullSearch(
		...
		Date min = URL.convertDate(minDate, new Date(0L)); 	//Default date: 1-1-1970
		Date max = URL.convertDate(maxDate, new Date()); 	//Current system instant
